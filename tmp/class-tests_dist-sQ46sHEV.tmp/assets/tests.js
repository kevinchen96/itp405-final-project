...
define('itp405-final-project/tests/controllers/create-event.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/create-event.js should pass jshint.\ncontrollers/create-event.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/create-event.js: line 3, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/create-event.js: line 11, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/create-event.js: line 15, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/create-event.js: line 52, col 57, Missing semicolon.\ncontrollers/create-event.js: line 55, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\n\n6 errors');
  });
});
...
define('itp405-final-project/tests/unit/controllers/create-event-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  // Replace this with your real tests.
  (0, _emberQunit.test)('date should be set at min date', function (assert) {
    assert.expect(1);

    // get the controller instance
    var ctrl = this.subject();
    var value = ctrl.get('mindate').format('YYYY-MM-DD');
    ctrl.setTime("1995-05-05");
    // check the properties before the action is triggered
    assert.equal(this.view.$("input")[3].value, value);
  });
