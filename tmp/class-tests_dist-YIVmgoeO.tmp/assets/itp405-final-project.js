	...
	exports["default"] = _ember["default"].Controller.extend({
		...
		actions: {
			...
			createEvent: function createEvent() {
				this.set('mydate', moment(moment()).subtract('days', 1));
...
if (!runningTests) {
  require("itp405-final-project/app")["default"].create({"LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"rootElement":"#ember-testing","name":"itp405-final-project","version":"0.0.0+87ba025b"});
}
